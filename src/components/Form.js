              ...
              return(
                <View style={styles.container}>
                 <View style={styles.icon}>
                    {myIcon1}<TextInput style={styles.inputBox} 
                   ...
                   <View style={styles.icon}>           
                   {myIcon2}<TextInput style={styles.passBox} 
                    ...
                    <TouchableOpacity>
                    <Text style={{color:'red', textDecorationLine:'underline', marginTop:10}}>Forgot a password?</Text>
                    </TouchableOpacity>
                </View>
              );
          }
