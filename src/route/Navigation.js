...
import Icon from 'react-native-vector-icons/MaterialIcons';
    ...
    export default class Navigation extends Component{
        ...
        render(){
          return(
            <AppContainer onButtonPress={this.props.navigation}/>             
          );
        }
      }
        ...
        defaultNavigationOptions: props => {
          ...
          return { headerRight: (
            ...
            <View>
              <Menu
                 ref={this.setMenuRef}
                 button={<Icon name="more-vert" color='white' size={25} style={{padding:10}} onPress={this.showMenu}/>}
              >
                  <MenuItem onPress={this.onLogin}>Login</MenuItem>
                  <MenuItem onPress={this.onSignUp}>SignUp</MenuItem>
                  <MenuItem onPress={this.hideMenu}>Employer Zone</MenuItem>
